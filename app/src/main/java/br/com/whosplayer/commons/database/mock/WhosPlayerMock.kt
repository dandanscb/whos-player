            ...
            SoccerPlayerResponse(
                ...
                teams = getListWithFourTeamsResponse(
                    listOf(
                        TeamResponse(
                            name = "Bryne",
                            crest = "https://upload.wikimedia.org/wikipedia/en/6/6f/Bryne_FK_logo.svg",
                            year = "2015–2017"
                        ),
                        TeamResponse(
                            name = "Molde",
                            crest = "https://upload.wikimedia.org/wikipedia/pt/d/d5/Molde_Fotball_Logo.png",
                            year = "2017–2019"
                        ),
                        TeamResponse(
                            name = "Red Bull Salzburg",
                            crest = "https://logodetimes.com/times/red-bull-salzburg/logo-red-bull-salzburg-1024.png",
                            year = "2019–2020"
                        ),
                        TeamResponse(
                            name = "Borussia Dortmund",
                            crest = "https://logodetimes.com/times/borussia-dortmund/borussia-dortmund-4096.png",
                            year = "2020–2022"
                        ),
                        TeamResponse(
