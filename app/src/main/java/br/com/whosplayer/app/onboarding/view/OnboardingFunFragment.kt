...
class OnboardingFunFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_whos_player_onboarding_fun, container, false)

        val transparentButton = rootView.findViewById<ImageButton>(R.id.close_button)
